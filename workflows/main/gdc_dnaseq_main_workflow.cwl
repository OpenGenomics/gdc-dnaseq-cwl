...
steps:
  ...
  readgroups_bam_to_readgroups_fastq_lists:
    run: ../utils/readgroups_bam_to_readgroups_fastq_lists.cwl
  ...
  merge_fastq_arrays:
    run: ../utils/merge_fastq_array_workflow.cwl
    in:
  ...
  conditional_skip_markduplicates:
    run: ../utils/conditional_skip_markduplicates.cwl
